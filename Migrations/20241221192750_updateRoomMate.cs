    ...
    public partial class updateRoomMate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoommateAdFavorites", x => x.FavoriteId);
                    table.ForeignKey(
                        name: "FK_RoommateAdFavorites_RoommateAds_RoommateAdId",
                        column: x => x.RoommateAdId,
                        principalTable: "RoommateAds",
                        principalColumn: "AdId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoommateAdFavorites_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoommateAdFavorites_RoommateAdId",
                table: "RoommateAdFavorites",
                column: "RoommateAdId");

            migrationBuilder.CreateIndex(
                name: "IX_RoommateAdFavorites_UserId",
                table: "RoommateAdFavorites",
                column: "UserId");
